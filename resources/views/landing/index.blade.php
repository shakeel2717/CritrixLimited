...
<head>
    ...
    <style data-merge-styles="true"></style>
    <meta charset="UTF-8">
    <link rel="icon" type="image/svg+xml" href="/favicons/favicon-96x96.png">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title> {{ config('app.name') }}</title>
    <link rel="stylesheet" href="/assets/index.7488fba1.css">

</head>

<body>
    <div id="root">
        <div class="bg-primary text-white w-full overflow-hidden">
            <div class="false sm:px-16 px-6 flex justify-center items-center">
                <div class="xl:max-w-[1280px] w-full">
                    <nav class="w-full xl:max-w-[1280px] w-full flex py-6 justify-between items-center navbar">
                        <img src="{{ asset('assets/images/logo-icon.png') }}" alt="{{ config('app.name') }}"
                            class=" w-[30%] ss:w-[20%] sm:w-[15%] md:w-[10%]">
                        <a href="{{ route('login') }}" class="flex md:hidden">Sign In</a>
                        <ul class="list-none md:flex hidden justify-end items-center flex-1">
                            <li
                                class="font-poppins font-normal cursor-pointer text-[16px] hover:text-secondary text-white mr-10">
                                <a href="{{ route('user.dashboard.index') }}">Home</a>
                            </li>
                            <li
                                class="font-poppins font-normal cursor-pointer text-[16px] hover:text-secondary text-dimWhite mr-10">
            ...
            <div class="sm:px-16 px-6 flex justify-center items-center">
                <div class="xl:max-w-[1280px] w-full">
                    <section id="home" class="flex md:flex-row flex-col md:py-24 ss:py-12 py-4">
                        <div class="flex-1 flex justify-center items-start flex-col">
                            <div
                                class="flex flex-row items-center py-[6px] px-4 transparent-gradient rounded-[10px] mb-2">
                                <p
                                    class="font-poppins font-normal text-greyish text-[16px] md:text-[18px] leading-[30.8px] ml-2">
                                    <span class="text-white">Your Trusted Partner in Stock, Crypto & Forex Markets
                                </p>
                            </div>
                            <div class="flex flex-row justify-between items-center w-full relative">
                                <h1
                                    class="flex-1 font-poppins font-semibold lg:text-[65px] sm:text-[55px] text-[37px] text-white sm:leading-[100.8px] leading-[75px]">
                                    Maximize Your <br><span class="primary_text_shade break-all">Investments
                                    </span><br>with IQTradex </h1>

                            </div>
                            <p
                                class="font-poppins font-normal text-greyish text-[16px] md:text-[18px] leading-[30.8px] max-w-[80%] md:max-w-[80%] lg:max-w-[85%] mt-5">
                                Invest smart, earn confidently, and watch your portfolio grow with expert-managed funds
                                across global markets.</p>
                            <button type="button"
                                class="flex flex justify-center items-center py-4 px-8 my-8 font-poppins font-medium text-[16px] text-primary primary_gradient rounded-full outline-none [object Object]"
                                onclick="window.location.href='/register'">Create Account <span class="ml-3"> <svg
                        ...
                        <div class="flex-1 flex flex md:justify-end items-center justify-start relative"><img
                                src="/assets/bitcoin.2e756e69.png" alt="bitocin"
                                class="h-[280px] ss:h-[450px] object-contain">
                            <div class="hidden sm:flex absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient"></div>
                            <div
                                class="hidden sm:flex absolute z-[1] w-[80%] h-[80%] rounded-full white__gradient bottom-40">
                            </div>
                            <div
                                class="hidden sm:flex absolute z-[0] w-[50%] h-[50%] right-20 bottom-20 blue__gradient">
                            </div>
                        </div>
                    </section>
                </div>
            ...
            <div id="coinmarketcap-widget-marquee" coins="1,1027,825,74,5994,52,32195,32698,33323" currency="USD"
                theme="dark" transparent="false" show-symbol-logo="true"></div>
            <div class="sm:px-16 px-6 flex justify-center items-center">
                <div class="xl:max-w-[1280px] w-full">

                    <section id="features" class="md:py-24 ss:py-12 py-4">
                        <div class="block ss:hidden min-h-[100px]"></div>
                        <h2
                            class="text-center font-poppins font-semibold md:text-[50px] sm-text-[40px] text-[35px] text-white sm:leading-[76.8px] leading-[66.8px] w-full">
                            We provide you the best</h2>
                        <p
                            class="font-poppins font-normal text-greyish text-[16px] md:text-[18px] leading-[30.8px] mt-5 text-center">
                            Best services provided by our community</p>
                        <div class=" md:py-24 ss:py-12 py-4 flex items-center justify-between text-center flex-wrap">
                            <div
                                class=" rounded-[10px] mr-5 p-5 w-[100%] ss:w-[90%] sm:w-[46%] md:w-[30%] feature-card">
                                <div
                                    class="text-4xl p-4 my-5 text-center inline-block w-auto primary_gradient rounded-full">
                                ...
                                <h1 class="text-white text-xl font-medium"> Expert-Managed Investments</h1>
                                <p class="font-normal text-greyish text-[14px] leading-[30.8px] mt-5 text-center">Our
                                    team has decades of combined experience in stock and crypto markets, ensuring your
                                    funds are in safe hands. </p>
                            </div>
                            <div
                                class=" rounded-[10px] mr-5 p-5 w-[100%] ss:w-[90%] sm:w-[46%] md:w-[30%] feature-card">
                                <div
                                ...
                                <h1 class="text-white text-xl font-medium"> Diversified Portfolio</h1>
                                <p class="font-normal text-greyish text-[14px] leading-[30.8px] mt-5 text-center">Your
                                    funds are spread across a diversified portfolio of stocks and cryptocurrencies,
                                    reducing risk and maximizing growth opportunities.</p>
                            </div>
                            <div
                                class=" rounded-[10px] mr-5 p-5 w-[100%] ss:w-[90%] sm:w-[46%] md:w-[30%] feature-card">
                                <div
                                ...
                                <h1 class="text-white text-xl font-medium"> Secure & Trusted Platform</h1>
                                <p class="font-normal text-greyish text-[14px] leading-[30.8px] mt-5 text-center">Your
                                    security is our priority. We use advanced encryption and security protocols to
                                    ensure your funds and personal information are safe.</p>
                            </div>
                        </div>
                        <div class="flex justify-center items-center">
                            <a type="button"
                                class="flex flex justify-center items-center py-4 px-8 my-8 font-poppins font-medium text-[16px] text-primary primary_gradient rounded-full outline-none [object Object]"
                                href="{{ asset('paper.pdf') }}">Download PDF </a>
                        </div>
                    ...
                    <section id="community"
                        class="flex md:flex-row flex-col md:py-24 ss:py-12 py-4 xl:max-w-[1280px] w-full md:py-24 ss:py-12 py-4">
                        <div class="block ss:hidden min-h-[100px]"></div>
                        <div class="flex-1 flex justify-center items-start flex-col">
                            <h2
                                class="font-poppins font-semibold md:text-[50px] sm-text-[40px] text-[35px] text-white sm:leading-[76.8px] leading-[66.8px] w-full">
                                Your Gateway to Safe and Profitable <br class="hidden md:flex"> Investment Opportunities
                            </h2>
                            <p
                                class="font-poppins font-normal text-greyish text-[16px] md:text-[18px] leading-[30.8px] max-w-[470px] mt-5">
                                we offer a unique and secure platform where individuals can pool their funds together to
                                invest in some of the most dynamic markets today – the stock exchange and
                                cryptocurrency.</p>
                            <div class="my-5 flex sm:items-center justify-between w-[100%] flex-wrap">
                                <div class="my-5 w-[40%] lg:w-[33%]">
                                    <h1 class="text-3xl sm:text-5xl font-medium font-poppins mb-3">22k+</h1>
                                    <p
                                        class="md:w-[95%] font-poppins font-normal text-greyish leading-[30.8px] text-[16px]">
                                        People who have joined {{ config('app.name') }}</p>
                                </div>
                                <div class="my-5 w-[40%] lg:w-[33%]">
                                    <h1 class="text-3xl sm:text-5xl font-medium font-poppins mb-3">250+</h1>
                                    <p
                                        class="md:w-[95%] font-poppins font-normal text-greyish leading-[30.8px] text-[16px]">
                                        Famous People playing {{ config('app.name') }}</p>
                                </div>
                                <div class="my-5 w-[40%] lg:w-[33%]">
                                    <h1 class="text-3xl sm:text-5xl font-medium font-poppins mb-3">34+</h1>
                                    <p
                                        class="md:w-[95%] font-poppins font-normal text-greyish leading-[30.8px] text-[16px]">
                                        Worldwide Brokers</p>
                                </div>
                        ...
                        <div class="flex items-center justify-center">
                            <div class="row"><svg class="map-img" xmlns="http://www.w3.org/2000/svg" width="672"
                                    height="315" viewBox="0 0 672 315" id="svg5249">
                                    <defs id="defs5257">
                                        <linearGradient id="linearGradient4299">
                                            <stop offset="0" id="stop4301" stop-color="#cc5252"></stop>
                                        </linearGradient>
                                        <linearGradient id="linearGradient4293">
                                            <stop offset="0" id="stop4295" stop-color="#84297f"></stop>
                                        </linearGradient>
                                    </defs>
                                    <g id="AF" class="map-unselected">
                                        <path id="path4307"
                    ...
                    <section id="features" class="md:py-24 ss:py-12 py-4">
                        ...
                        <p
                            class="font-poppins font-normal text-greyish text-[16px] md:text-[18px] leading-[30.8px] mt-5 text-center">
                            We are trusted by some of the world’s biggest and most dynamic markets</p>
                        <div class=" md:py-24 ss:py-12 py-4 flex items-center justify-between text-center flex-wrap"
                            style="gap: 20px; justify-content: center">
                            <img src="{{ asset('partners/1.png') }}" alt="Partners" width="200">
                            <img src="{{ asset('partners/2.png') }}" alt="Partners" width="200">
                            <img src="{{ asset('partners/3.png') }}" alt="Partners" width="200">
                            <img src="{{ asset('partners/4.png') }}" alt="Partners" width="200">
                            <img src="{{ asset('partners/5.png') }}" alt="Partners" width="200">
                        </div>
                    </section>
                            ...
                            <div style="overflow: auto;">
                                <table class="mx-auto table-auto">
                                    ...
                                    <tbody class="text-white">
                                        @foreach (App\Models\Transaction::whereIn('type', ['withdraw', 'deposit'])->latest()->limit(10)->get() as $deposit)
                                            <tr>
                                                <td class="py-4 px-4 text-gray-700">
                                                    {{ str()->mask($deposit->user->username, '*', 3, 5) }}</td>
                                                <td class="py-4 px-4 text-gray-700">
                                                    <span class="text-uppercase fw-bold text-light">
                                                        {{ $deposit->type }}
                                                    </span>
                                                </td>
                                                <td class="fw-bold py-4 px-4 text-gray-700">
                    ...
                    <section id="explore" class="flex flex-col md:flex-row md:py-24 ss:py-12 py-4">
                        <div class="flex-1 flex justify-center items-start flex-col">
                            <h2
                                class="font-poppins font-semibold md:text-[50px] sm-text-[40px] text-[35px] text-white sm:leading-[76.8px] leading-[66.8px] w-full">
                                Move ahead with us to <br class="hidden md:block">explore the world</h2>
                            <p
                                class="font-poppins font-normal text-greyish text-[16px] md:text-[18px] leading-[30.8px] max-w-[470px] mt-5">
                                IQTradex offers a range of investment options that suit your needs. Our flexible
                                investment plans cater to different risk profiles and investment horizons.</p><button
                                type="button"
                                class="flex flex justify-center items-center py-4 px-8 my-8 font-poppins font-medium text-[16px] text-primary primary_gradient rounded-full outline-none [object Object]"
                                onclick="window.location.href='/register'">Let's Get Started <span class="ml-3">
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                        viewBox="0 0 1024 1024" height="1em" width="1em"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <div class="flex-1 flex flex justify-center items-center md:ml-10 ml-0 md:mt-0 mt-10 relative">
                            <img src="{{ asset('assets/images/girl.jpg') }}" alt="App">
                        </div>
                    </section>
                    <section id="contact">
                        <div class="block ss:hidden min-h-[100px]"></div>
                        <div
                            class="flex justify-center items-center sm:my-16 my-6 sm:px-16 px-6 sm:py-12 py-4 sm:flex-row flex-col bg-black-gradient-2 rounded-[20px] transparent_box_shadow">
                            <div class="flex-1 flex flex-col">
                                <h2
                                    class="font-poppins font-semibold md:text-[50px] sm-text-[40px] text-[35px] text-white sm:leading-[76.8px] leading-[66.8px] w-full">
                                    Get in touch with us!</h2>
                                <p
                                    class="font-poppins font-normal text-greyish text-[16px] md:text-[18px] leading-[30.8px] max-w-[470px] mt-2 sm:mt-5">
                                    you’re not just investing — you’re partnering with a team of financial experts
                                    dedicated to helping you grow your wealth. Let us handle the complexities of
                                    trading, so you can enjoy the rewards. Invest today and watch your financial future
                                    take shape with IQTradex.</p>
                            </div>
                            <div
                                class="md:flex justify-center items-center inline-block w-full sm:w-auto sm:ml-10 ml-0 sm:mt-0 mt-10">
                                <button type="button" onclick="window.location.href='/register'"
                                    class="flex flex justify-center items-center py-4 px-8 my-8 font-poppins font-medium text-[16px] text-primary primary_gradient rounded-full outline-none [object Object]">Join
                                    Us Today </button>
                            </div>
                        </div>
                    </section>
                    <section class="flex justify-center items-center md:py-24 ss:py-12 py-4 flex-col">
                        <div
                            class="w-full text-center flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
                            <p
                                class="font-poppins font-normal text-greyish text-[16px] md:text-[18px] leading-[30.8px]">
                                Copyright Ⓒ {{ date('Y') }} {{ config('app.name') }}. All Rights Reserved.</p>
                            <div class="flex flex-row md:mt-0 mt-6">
                                <!-- <div class="cursor-pointer mr-6"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" class="text-2xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="cursor-pointer mr-0"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" class="text-2xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
