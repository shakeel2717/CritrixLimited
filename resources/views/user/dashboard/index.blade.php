    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert bg-light text-center">
                <a href="{{ asset('critrix.pdf') }}" class="alert-link">Download our
                    Whitepaper</a>
            </div>
        </div>
        <div class="col-md-12">
            ...
            <div class="card radius-10 w-100 overflow-hidden">
                ...
                <div class="card-footer bg-transparent border-top-0">
                    <div class="d-flex align-items-center justify-content-between text-center">
                        ...
                        <div class="mb-1">
                            <h6 class="mb-1 font-weight-bold">
                                {{ Number::currency(auth()->user()->networkingCap(), 'MYR', 'ms_MY') }}</h6>
                    ...
                    <div class="d-flex align-items-center justify-content-between text-center">
                        <div>
                            <h6 class="mb-1 font-weight-bold">
                                {{ Number::currency(auth()->user()->alreadyReceivedCap(), 'MYR', 'ms_MY') }}
                            </h6>
                            <p class="mb-0">Total Earned</p>
                        </div>
                        <div>
                            <h6 class="mb-1 font-weight-bold">
                                {{ Number::currency(auth()->user()->remainingCap(), 'MYR', 'ms_MY') }}</h6>
                            ...
                            <div class="card radius-10">
                                <div class="card-body">
                                    <div class="text-center">
                                        ...
                                        <h4 class="my-1">
                                            {{ Number::currency(auth()->user()->totalSalesOfDownline(), 'MYR', 'ms_MY') }}
                                        </h4>
