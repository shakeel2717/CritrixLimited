$(function () {
	...
	// networking capacity chart
	let networkingCapChart = document.getElementById("chart20");
	let totalCap = networkingCapChart.getAttribute("data-cap-total");
	let recievedCap = networkingCapChart.getAttribute("data-cap-recieved");
	let cap = (recievedCap / totalCap) * 100
	// return 0 if cap is NaN
	if (cap.toString() === 'NaN') {
		cap = 0;
	}
	cap = cap.toFixed(2);
	...
	// daily roi cap chart
	let networkingCapChartDaily = document.getElementById("dailyRoiChart");
	let totalCapDaily = networkingCapChartDaily.getAttribute("data-cap-total");
	let recievedCapDaily = networkingCapChartDaily.getAttribute("data-cap-recieved");
	let capDaily = (recievedCapDaily / totalCapDaily) * 100
	// return 0 if cap is NaN
	if (capDaily.toString() === 'NaN') {
		capDaily = 0;
	}
	capDaily = capDaily.toFixed(2);
	...
	new ApexCharts(document.querySelector("#dailyRoiChart"), e).render();
